...
const returnRouter = (io) => {
	...
	router.put('/account/update-user-profile-details', userAuthorize, userProfileController.updateUserProfileDetails);

	router.put('/account/update-user-profile-image', userAuthorize, userProfileController.updateUserProfileImage);
